...
class FlavorContainer extends StatelessWidget {
      ...
      child: GetBuilder<CustomCakeController>(builder: (_) {
        return Container(
          ...
          decoration: BoxDecoration(
              ...
              color: controller.selectedFlavor.value == null
                  ? null
                  : controller.selectedFlavor.value!.id == model.id
            ...
            children: [
              SizedBox(
                ...
                child: CachedNetworkImage(
                    imageUrl: EndPoints.imageBaseUrl +model.image!, fit: BoxFit.contain),
              ),
